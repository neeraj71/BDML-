...
MapReduce works on top of GFS. So, the basic infrastructure of dividing the files is same as we saw in GFS. We have a master node and thousand of chunservers (workers) where the actual computation is performed.
